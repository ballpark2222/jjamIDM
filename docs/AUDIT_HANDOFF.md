...
- Bundles verify via Ed25519SignatureVerifier (fdmsig/1: sha256 +
  pinned-key ed25519). The shipped key is a DEV key generated by
  tools/component-sign — swap for a release key before launch.
